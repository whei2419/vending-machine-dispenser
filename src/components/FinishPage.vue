<template>
  <div class="page-finish" :style="backgroundStyle">
    ...
    <div class="score-card">
      ...
      <p class="score-message">Please proceed to our crew and redeem the free gift.</p>
    </div>

    <div class="buttoncontainer">
      <button type="button" class="start-button" :class="{ loading: isLoading }" @mouseover="handleInteraction"
