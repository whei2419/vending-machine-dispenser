...
function preload() {
  ...
  this.load.image(
    "gamebg",
    "../assets/dutch/mainBackground.webp" + cacheBuster,
  );
  ...
  this.fallingObjects = [
    ...
    {
      key: "apple",
      path: "../assets/dutch/fallingObjects/normal/magnify.webp" + cacheBuster,
      type: "normal",
      points: gameConfig.appleScore,
    },
    {
      key: "banana",
      path: "../assets/dutch/fallingObjects/normal/octagon.webp" + cacheBuster,
      type: "normal",
      points: gameConfig.bananaScore,
    },
    {
      key: "carrot",
      path: "../assets/dutch/fallingObjects/normal/world.webp" + cacheBuster,
      type: "normal",
